...
const
  LSelect =
    'SELECT ID, NOME_CLIENTE, VALOR_TOTAL, STATUS, ID_GARCOM, ID_MESA FROM PEDIDO WHERE STATUS = ''A'' OR STATUS = ''C'' ORDER BY ID';
{$EndRegion}
var
  LDataSet : TDataSet;
begin
...
const
  LSelect =
    'SELECT ID, NOME_CLIENTE, VALOR_TOTAL, STATUS, ID_GARCOM, ID_MESA FROM PEDIDO WHERE ID =:pID';
{$EndRegion}
var
  LDataSet : TDataSet;
begin
...
const
  LSelect =
    'SELECT ID, NOME_CLIENTE, VALOR_TOTAL, STATUS, ID_GARCOM, ID_MESA FROM PEDIDO WHERE 1 = 2';
  LSelectResult =
    'SELECT ID, NOME_CLIENTE, VALOR_TOTAL, STATUS, ID_GARCOM, ID_MESA FROM PEDIDO WHERE ID = :pID_PEDIDO';
{$EndRegion}
var
  LDataSet : TDataSet;
  LJSON    : TJSONObject;
...
const
  LSelect =
    'SELECT ID, NOME_CLIENTE, STATUS, ID_GARCOM, ID_MESA, STATUS FROM PEDIDO WHERE ID = :pID';
{$EndRegion}
var
  LDataSet      : TDataSet;
  LJSON         : TJSONValue;
...
const
  LSelect =
    'SELECT ID, NOME_CLIENTE, VALOR_TOTAL, STATUS, ID_GARCOM, ID_MESA FROM PEDIDO WHERE ID_MESA =:pID_MESA';
{$EndRegion}
var
  LDataSet : TDataSet;
begin
